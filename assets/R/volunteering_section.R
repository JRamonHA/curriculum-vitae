...
volunteering_section <- function(xlsx = "data/cv.xlsx", sheet = "volunteering", page_break_after = FALSE) {
  ...
  if (page_break_after) {
    c("## Volunteering {data-icon=handshake-angle .break-after-me}", text)
  } else {
    c("## Volunteering {data-icon=handshake-angle}", text)
  }
}
